...
func geniPreset(inst *instance) error {
	...
	preset := map[string]any{
		...
		"challenge": map[string]any{
			...
			"scavengers":          tryCfgGetD(tryPickNumberGen("settingsScavs"), 0, inst.cfgs...),
			"alliances":           tryCfgGetD(tryPickNumberGen("settingsAlliance"), 2, inst.cfgs...),
			"powerLevel":          tryCfgGetD(tryPickNumberGen("settingsPower"), 2, inst.cfgs...),
			"bases":               tryCfgGetD(tryPickNumberGen("settingsBase"), 2, inst.cfgs...),
